...
public class RegitrarDatosCuentaActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_siguiente).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(RegitrarDatosCuentaActivity.this, RegistrarDatosPersonalesActivity.class));
            }
        });
        findViewById(R.id.btn_volver).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(RegitrarDatosCuentaActivity.this, MainActivity.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_regitrar_datos_cuenta, menu);
        return true;
    }
