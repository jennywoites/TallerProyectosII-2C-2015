...
public class EncontradasFragment extends Fragment {
    ...
    private static final String TAG = "EncontradasFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // View:
        mainView = inflater.inflate(R.layout.fragment_encontradas, container, false);
        mainView.setTag(TAG);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.action_buscar_encontrada:
                buscarEncontrada();
                return true;
