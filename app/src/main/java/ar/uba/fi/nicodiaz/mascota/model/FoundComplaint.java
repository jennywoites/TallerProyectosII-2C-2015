 ...
 */
@ParseClassName("DenunciaPublicacionEncontrada")
public class FoundComplaint extends ParseObject implements Complaint {
    ...
    public Pet getPublication() {
        FoundPet pet = (FoundPet) getParseObject(PUBLICATION);
        try {
