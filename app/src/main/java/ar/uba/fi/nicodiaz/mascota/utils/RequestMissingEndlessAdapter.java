 ...
 */
public class RequestMissingEndlessAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<MissingRequest> missingRequests;
    ...
    public RequestMissingEndlessAdapter(List<MissingRequest> missingRequests, RecyclerView recyclerView, Context context) {
        this.missingRequests = missingRequests;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ITEM) {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_request_missing, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder instanceof MascotaViewHolder) {
            ...
            MissingRequest missingRequest = missingRequests.get(i);
            ...
            ParseFile photoFile = missingPet.getPicture();
            if (photoFile != null) {
            ...
            view.mascotaName.setText(missingPet.getName());
            view.mascotaDescription.setText(missingPet.getPreviewDescription());

            if (missingPet.isMale()) {
            ...
            int iconPetID = PetServiceFactory.getInstance().getIconPet(missingPet.getKind());
            if (iconPetID != -1) {
            ...
            if (missingRequest.isAccepted()) {
                view.requestDescription.setText("Estado Solicitud: A Confirmar");
                view.requestStatusIcon.setImageResource(R.drawable.ic_action_approved_white);
            } else if (missingRequest.isPending()) {
            ...
            } else if (missingRequest.isConfirmed()) {
                view.requestDescription.setText("Estado Solicitud: Encontrada");
            ...
            view.currentMascota = missingPet;
        } else {
    ...
    public int getItemCount() {
        return missingRequests == null ? 0 : missingRequests.size();
    }

    @Override
    public int getItemViewType(int position) {
        return missingRequests.get(position) != null ? VIEW_ITEM : VIEW_PROG;
    }
