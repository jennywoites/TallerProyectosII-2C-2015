...
public class TestMultiLevelExpIndListAdapter extends AndroidTestCase {
    ...
    public void testAddAllCollapseExpand() {
        ...
        List<Integer> gSizes = new ArrayList<>();
        pos.add(3);
        gSizes.add(1);
    ...
    private List<MockData> getDummyData() {
        ...
        MockData d1 = new MockData();
        MockData d1_1 = new MockData();
        MockData d1_2 = new MockData();
        MockData d1_2_1 = new MockData();
        MockData d1_2_1_1 = new MockData();
        MockData d1_2_2 = new MockData();
        MockData d1_2_2_1 = new MockData();
        MockData d1_3 = new MockData();
        data.add(d1);
        data.add(d1_1);
        data.add(d1_2);
        data.add(d1_2_1);
        ...
        MockData d2 = new MockData();
        MockData d2_1 = new MockData();
        MockData d2_1_1 = new MockData();
        MockData d2_1_1_1 = new MockData();
        MockData d2_1_1_1_1 = new MockData();
        MockData d2_1_1_1_2 = new MockData();
        MockData d2_2 = new MockData();
        MockData d2_2_1 = new MockData();
        MockData d2_2_2 = new MockData();
        MockData d2_2_3 = new MockData();
        data.add(d2);
        data.add(d2_1);
        data.add(d2_1_1);
        data.add(d2_1_1_1);
